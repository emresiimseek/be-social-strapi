...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    firstname: Attribute.String;
    lastname: Attribute.String;
    owner_events: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::event.event'
    >;
    events: Attribute.Relation<
      ...
      'api::event.event'
    >;
    user_likes: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::event.event'
    >;
    event_requests: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
    ...
    like_posts: Attribute.Relation<
      ...
      'api::post.post'
    >;
    users_follow: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    users_follow_me: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface ApiEventEvent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    attendees: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    event_likes: Attribute.Relation<
      'api::event.event',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface ApiNotificationNotification extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    event_request: Attribute.Relation<
      'api::notification.notification',
      'manyToOne',
      'api::event-request.event-request'
    >;
